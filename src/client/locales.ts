...
export const zh = {
  ...
  knobSpecular: '高光',
  presetTitle: '壁纸',
  presetDescription: '点选一张作为当前壁纸。内置四张始终在；自定义图只存在此浏览器。长按水滴循环内置场景。',
  presetRidge: '山脊线稿',
  presetCoast: '海岸线稿',
  presetGarden: '庭院线稿',
  presetArch: '拱门线稿',
...
export const en: Record<LiquidGlassLocaleKey, string> = {
  ...
  presetDescription: 'Pick a wallpaper. The four line-art scenes are always there; custom images stay in this browser. Long-press the droplet to cycle the built-ins.',
